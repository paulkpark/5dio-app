...
const I18N = {
  'ko': {
    ...
    'carrier_enable':'활성화',
    'carrier_freq':'반송파 주파수',
    'carrier_depth':'변조 깊이',
    'carrier_mode':'변조 방식',
    'carrier_mode_am':'AM (반송파 유지)',
    'carrier_mode_ring':'링 변조 (반송파 억압)',
    'carrier_wave':'반송파 파형',
    'carrier_duty':'반송파 듀티',
  ...
  'en': {
    ...
    'carrier_enable':'Enable',
    'carrier_freq':'Carrier Frequency',
    'carrier_depth':'Modulation Depth',
    'carrier_mode':'Modulation Type',
    'carrier_mode_am':'AM (carrier retained)',
    'carrier_mode_ring':'Ring Mod (carrier suppressed)',
    'carrier_wave':'Carrier Waveform',
    'carrier_duty':'Carrier Duty',
    ...
    'gen.panel.carrier':'Carrier / Modulation',
    ...
    'gen.intro.tag':'Introduction · Quick Manual · v4.4',
